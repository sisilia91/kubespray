...
hypercloud_hpcd_single_operator_version: hypercloud-single-operator의 버전 "5.0.20.1"
hypercloud_hpcd_multi_operator_version: hypercloud-multi-operator의 버전 "5.0.20.0"
hypercloud_hpcd_api_server_version: hypercloud-api-server의 버전 "5.0.20.0"
